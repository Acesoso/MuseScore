...
enum class Code : char16_t {
    ...
    BEAM_BREAK_RIGHT = 0xF4C0,
    BEAM_BREAK_BOTH = 0xF4C1,
    BEAM_JOIN_RIGHT = 0xF4C2,
    BEAM_JOIN_LEFT = 0xF4C3,
    BEAM_JOIN_BOTH = 0xF4C4,
    BEAM_BREAK_INNER_PROGRESSIVE = 0xF4C5,
    BEAM_JOIN_INNER_PROGRESSIVE = 0xF4C6,
